"""
Django settings for hh_laba project.
...
SECRET_KEY = 'django-insecure-3ieu5!d#a#-d#!%*)8f$=q6$m3s9lnsdgu9^5%^-p+%0zrq^9m'
...
WSGI_APPLICATION = 'hh_laba.wsgi.application'
